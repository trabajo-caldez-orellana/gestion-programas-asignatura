# Generated by Django 4.2.4 on 2024-03-31 13:16
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('accion', models.CharField(choices=[('CN', 'Crear nuevo programa de asignatura'), ('E', 'Editar programa de asignatura'), ('P', 'Presentar programa de asignatura para aprobación'), ('A', 'Aprobar programa de asignatura'), ('RU', 'Reutilizar úlitmo programa de asignatura'), ('PC', 'Pedir cambios en el programa de asignatura')], max_length=2)),
