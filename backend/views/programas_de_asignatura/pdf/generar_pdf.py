...
class GenerarPDF(APIView):
    ...
    def get(self, request, id_programa):
        ...
        header = header.render(stylesheets=[CSS(string='@page {size:A4; margin:0 1cm;} body {position: fixed; top: 0cm;}')])
        ...
        footer = footer.render(stylesheets=[CSS(string='@page {size:A4; margin:0 1cm;} body {position: fixed; bottom: 0;}')])
