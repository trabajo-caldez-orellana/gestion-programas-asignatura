...
MENSAJE_SOLO_UN_PROGRAMA_POR_SEMESTRE = (
    "Solo es posible crear una Programa de Asignatura por semestre."
)
MENSAJE_NO_SE_CREARON_SEMESTRES = "No hay semestres creados."
MENSAJE_NO_HAY_SEMESTRES_ANTERIORES = "No hay semestres anteriores al semestre actual."
